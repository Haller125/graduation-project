...
void tournamentSelection(std::vector<std::array<float, NUM_OF_HEURISTICS>>& population, std::vector<float>& fitness, std::vector<std::array<float, NUM_OF_HEURISTICS>>& matingPool);
